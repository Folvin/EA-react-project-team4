...
function EaNavButton({ icon, url, text, handleToggle }: Props) {
    return (
        <Link to={url}>
            <div onClick={handleToggle} className="hover:-translate-y-2 transition-all w-full flex flex-row lg:flex-col mb-4 md:mb-0 justify-start lg:justify-center items-center md:p-8" >
