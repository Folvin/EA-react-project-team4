...
const language = [
  ...
  { id: 2, name: 'United Kingdom', img: 'assets/global/country-flag/united-kindom.png' },
  { id: 3, name: 'Australia', img: 'assets/global/country-flag/australia.png' },
  { id: 4, name: 'United States', img: 'assets/global/country-flag/united-states.png' },
  ...
  { id: 7, name: 'United States', img: 'assets/global/country-flag/united-states.png' },
  ...
  { id: 13, name: 'Česká republika', img: 'assets/global/country-flag/czech.png' },
  ...
  { id: 19, name: 'Nederland', img: 'assets/global/country-flag/Netherlands.png' },
    ...
    <div className="flex flex-col grow">
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="grow-[4] min-w-[400px] basis-0 shrink-0 flex flex-col md:flex-row gap-8">
          ...
          <SelectBox className="flex-1 z-10">
