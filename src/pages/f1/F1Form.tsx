...
function F1Form({ bgColor, textColor }: Props) {
  ...
  return (
    <div className={`${textColor}`}>
      {/*E-mail */}
      <div
        className={`${bgColor} h-16 group border-2 w-full rounded-sm mb-5 focus-within:text-sm focus-within:scale-105 hover:scale-105 ease-in-out duration-200`}>
        <div
      ...
      <div className="flex flex-col gap-y-5 md:flex-row md:gap-x-5 justify-between">
        {/*Data di nascita */}
        <div
          className={`${bgColor} group w-full   md:w-1/2 h-16 border-2 rounded focus-within:text-sm focus-within:scale-105 hover:scale-105 ease-in-out duration-200  `}>
          <div
        ...
        <div
          className={`${bgColor} relative group border-2 rounded w-full md:w-1/2 h-16 flex justify-start flex-col focus-within:text-sm hover:scale-105 ease-in-out duration-200 `}>
          <div
          ...
          <div className="absolute w-full top-4">
            <SelectPaese bgColor={bgColor} borderColor={''} textColor={textColor} />
          </div>
        </div>
      </div>
      ...
      <div className="flex mt-4 font-f1-regular">
        <div
          className={`${bgColor} border-2 rounded-sm w-12 h-4 md:w-8 md:h-4 mr-2 mt-1 flex justify-center items-center`}
          onClick={handleCheckBox}>
          {checkBox ? <div className={`w-full h-full z-10 `}></div> : null}
        </div>
        <p>
