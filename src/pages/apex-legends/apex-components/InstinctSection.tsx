...
function InstinctSection() {
  return (
    <div className="relative min-h-[300px] md:min-h-[450px] lg:h-[550px] 2xl:h-[690px] bg-none md:bg-center lg:bg-top md:bg-cover md:bg-[url('../public/assets/pages/apex-legends/instinct3.jpg')] lg:bg-[url('../public/assets/pages/apex-legends/instinct2.jpg')]">
        ...
        <div className="flex flex-col items-center pt-6 gap-3 justify-center">
          ...
          <div
            ...
            <div className={`2xl:text-xl text-base md:text-lg`}>
              ...
              addestrata per sopravvivere alle condizioni più brutali. Esplora un Canyon dei Re
